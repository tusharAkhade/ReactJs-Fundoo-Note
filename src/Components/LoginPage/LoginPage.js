      ...
      <div className="login-container">
        <div className="login-details">
          ...
          <div className="text">
            ...
            <div className="text2">to continue to Gmail</div>
          </div>
          ...
          <div className="login-password-container">
            <TextField className="login-password-text" type={this.state.showPassword ? 'text' : 'password'} size='small' id="" label="Password" helperText={this.state.helperTextPassword} error={this.state.errorPassword} variant="outlined" onChange={this.takePassword} />
          </div>
          ...
          <div className="lastRow">
            <div className="CreateAccText" onClick={this.handleCreateAccountClick}>Create account</div>

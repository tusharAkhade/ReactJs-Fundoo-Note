            ...
            <div className="signup-container">
                <div className="signup-details-and-advertise-container">
                    ...
                    <div className="signup-details">
                        ...
                        <div className="row-1">
                            <TextField className="name-text" size='small' style={{ marginRight: "10px" }} id="" label="First name" helperText={this.state.helperTextFirstName} error={this.state.errorFirstName} variant="outlined" onChange={this.takeFirstName} />
                            <TextField className="name-text" size='small' id="" label="Last name" helperText={this.state.helperTextLastName} error={this.state.errorLastName} variant="outlined" onChange={this.takeLastName} />
                        </div>

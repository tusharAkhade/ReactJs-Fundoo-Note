...
function MiniDrawer(props) {
    ...
    const listenClickNotes = () => {
        props.dispatch({ type: "CLICK_ON_KEEP" })
    }

    const listenClickArchive = () => {
        props.dispatch({ type: "CLICK_ON_ARCHIVE" })
    }

    const listenClickDelete = () => {
        props.dispatch({ type: "CLICK_ON_BIN" })
    }
    ...
    return (
        <div className={classes.root}>
            ...
            >
                <List>
                    <ListItem button key="Notes" onClick={listenClickNotes} >
                        <ListItemIcon>
                    ...
                    <ListItem button key="Archive" onClick={listenClickArchive} >
                        <ListItemIcon>
                    ...
                    <ListItem button key="Bin" onClick={listenClickDelete} >
                        <ListItemIcon>

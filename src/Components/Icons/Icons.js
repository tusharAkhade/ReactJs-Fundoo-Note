        ...
        <React.Fragment>
            ...
            <div className="noteTwoIcon">
                <div className={props.type == "displayNotes" ? "iconOfDisplayNotes" : "multipleIconsOfNote2"}>
                    <div className="iconOfNote2" id="iconOfNote2-1" onClick={handleReminderClick} ></div>
                    ...
                    <div className="iconOfNote2" id="iconOfNote2-2" onClick={listenToCollab} ></div>
                    <div className="iconOfNote2" id="iconOfNote2-3"> <ColorPopper className="iconOfNote2" getColor={props.getColor} /> </div>
                    <div className="iconOfNote2" id="iconOfNote2-4"></div>
                    <div className="iconOfNote2" id="iconOfNote2-5" onClick={handleArchiveClick} ></div>
                    <div className="iconOfNote2" id={props.type == "removeDeleteIconFromNoteTwoIcons" ? "removeDeleteIcon" : "iconOfNote2-6"} onClick={handleDeleteClick} >
